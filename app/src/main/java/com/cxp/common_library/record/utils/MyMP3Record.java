...
/**
 * Created by wangmaobo on 2018/9/21.
 */
public class MyMP3Record {
     ...
     */
    public MyMP3Record(File recordFile, RecordListener listener) {
    ...
    public void start() throws IOException {
        ...
        if (!checkPermission()) {
            ...
            mListener.hasRecordRight(System.currentTimeMillis());
        }
        new Thread() {
            @Override
            public void run() {
                ...
                if (recordingState != RECORDSTATE_STOPPED) {
                    mAudioRecord.stop();
